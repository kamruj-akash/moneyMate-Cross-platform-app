...
export const KEYS = {
  ...
  // True once we've prompted for notification permission. Stops us from
  // re-prompting on every cold launch — the user only sees the system
  // dialog the first time. They can flip it later from Settings.
  NOTIF_PERM_REQUESTED: '@moneymate:notif_perm_requested',
};
