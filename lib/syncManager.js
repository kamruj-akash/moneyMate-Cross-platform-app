...
export const processSyncQueue = async () => {
  ...
  // Process in dependency order: categories -> recurring -> user_settings -> transactions.
  // This avoids FK violations (transactions.category_id -> categories.id).
  const tableOrder = { categories: 1, user_settings: 2, recurring_transactions: 3, transactions: 4 };
